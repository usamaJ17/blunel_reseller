                                        ...
                                        <table class="table col-sm-xs-12">
                                            ...
                                            <form action="{{ route('admin.preference.setting.update') }}" method="post">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="300">
                                                        <label class="custom-switch mt-2 {{ hasPermission('seller_commission_update') ? '' : 'cursor-not-allowed' }}">
                                                            <input type="checkbox" name="custom-switch-checkbox"
                                                                   ...
                                                                   class="custom-switch-input {{ hasPermission('seller_commission_update') ? 'status-change' : '' }} category_commission"
                                                    ...
                                                    <tr class="seller_commission_rate {{settingHelper('category_commission_status') == 1 ? 'd-none' : ''}}">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="seller_commission_field {{settingHelper('category_commission_status') == 1 ? 'd-none' : ''}} {{settingHelper('seller_commission_status') == 0 ? 'd-none' : ''}}">
