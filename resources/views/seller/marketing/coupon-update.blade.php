                                ...
                                <table class="table col-12">
                                    <tr>
                                        ...
                                        <td width="70%" class="pl-0 pr-0">
                                            ...
                                            <input type="number" step="any" name="discount" id="discount" value="{{ old('discount') ? old('discount') : priceFormatUpdate($coupon_language->coupon->discount,settingHelper('default_currency'),$type="*") }}"  class="form-control" required>
                                ...
                                @if($coupon_language->coupon->type != "product_base")
                                    <div class="" id="div_invoice_base">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="minimum_shopping" id="minimum_shopping" value="{{ old('minimum_shopping') ? old('minimum_shopping') : priceFormatUpdate($coupon_language->coupon->minimum_shopping,settingHelper('default_currency'),$type="*") }}" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" name="maximum_discount" id="maximum_discount" value="{{ old('maximum_discount') ? old('maximum_discount') : priceFormatUpdate($coupon_language->coupon->maximum_discount,settingHelper('default_currency'),$type="*") }}" class="form-control">
